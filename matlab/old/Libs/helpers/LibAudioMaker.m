function [ result ] = LibAudioMaker( AudioMakerRequestPath )
%==========================================================================
...
fileName = sprintf('source_%drate-%drepeat-%dperiod+',FS,REPEAT_CNT,SINGLE_REPEAT_LEN);

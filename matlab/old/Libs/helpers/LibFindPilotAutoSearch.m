function [ pilotEndOffsets, pilotDiffers ] = LibFindPilotAutoSearch( signalAll, pilot, serchChIdxs, DEBUG_SHOW)
...
%           : algorithm: adjust the thres if need (ex: get 11 rather than 10 peaks)
    ...
    for chToSearchIdx = 1:PILOT_SEARCH_CH_CNT,
        ...
        for searchIdx = 1:MAX_FOR_LOOP_FOR_SEARCH,
            validPeakIdxs = LibGetValidPeaks( con, conMean + thres*conStd,  PILOT_SEARCH_PEAK_WINDOW, 0);
